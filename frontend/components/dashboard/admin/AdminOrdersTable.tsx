              ...
              orders.map((order: OrderData, i: number) => (
                <tr key={order.id} className={`${i !== orders.length - 1 ? 'border-b border-divider' : ''} hover:bg-accent-bg/30 transition-colors`}>
                  <td className="py-4 px-6">
                    <span className="font-sans font-semibold text-[13px] text-text-brand">#{order.orderId}</span>
                  </td>
                  <td className="py-4 px-6">
                  ...
                  <td className="py-4 px-6">
                    <span className="font-sans text-[13px] text-text-muted font-medium truncate block w-[160px]">{order.competition}</span>
                  </td>
                  <td className="py-4 px-6 text-center">
                    <span className="font-sans font-semibold text-[13px] text-text-primary">{order.tickets}</span>
                  </td>
                  <td className="py-4 px-6 text-center">
                    <span className="font-sans font-bold text-[13px] text-text-brand">£{order.amount.toFixed(2)}</span>
                  </td>
                  <td className="py-4 px-6 text-center">
                    <span className="font-sans text-[13px] text-text-muted font-medium">{order.payment}</span>
                  </td>
                  <td className="py-4 px-6 text-center">
