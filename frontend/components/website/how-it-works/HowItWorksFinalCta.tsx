...
export default function HowItWorksFinalCta() {
  return (
    <section className="bg-surface border-t border-b border-divider py-16 md:py-20 select-none relative overflow-hidden">
      <div className="container-custom flex flex-col items-center gap-6 text-center relative z-10">
        <h2 className="font-heading font-bold text-2xl sm:text-3xl md:text-4xl text-text-primary">
