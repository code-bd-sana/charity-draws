...
export const POSTAL_ENTRY_RULES: PostalEntryRulesConfig = {
  ...
  promoterName: "Charity Draws Ltd",
  promoterAddress: {
    line1: "Synergy House",
    line2: "Lawson Street",
    city: "North Shields",
  ...
  postcardDetails: [
    ...
    "Email Address (matching your Charity Draws account)",
  ...
  rulesList: [
    ...
    "You must have an active Charity Draws user account registered with the matching email address.",
  ],
  noticeText:
